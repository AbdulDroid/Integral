...
$router->get('/banks','BanksController@banks');

$router->get('/walletBalance', 'WalletController@walletBalance');
$router->get('/accountResolve', 'AccountNumberController@accountResolve');

$router->get('/walletCharge', 'WalletController@walletCharge');
